using SlackAPI;
using SlackInterface.Adapters;
using SlackInterface.Utilities;
using System;
...
namespace SlackInterface
{
    public class ConnectedInterface : UserControl
    {
        ...
        public ConnectedInterface(Slack connectedClient, LoginResponse loginDetails)
        {
        ...
        public void SendMessage(Action<Slack.ReceivingMessage> callback, string text, string channelId = null)
        {
